    ...
    <div class="apps-auth w-100 d-flex flex-column">
        <div class="logo mt-auto">
            ...
            <div class="col-10 col-sm-8 mx-auto my-4">
                <p class="info">ATTENTION : it is necessary to have a REFERRAL CODE for the
                    subscription on the
                    platform, if you do
                    not
            ...
            <div class="col-12 formbox-grey p-4 mb-3">
                <form class="form-login">
                    ...
                    <div class="apps-list-btn text-center d-grid gap-2">
                        ...
                        <a href="<?= base_url() ?>auth/form_signup" class="rounded fw-bold btn-ciak-o bg-gardien py-3 shadow-none">Submit</a>
                    </div>
                </form>
            </div>
            <div class="copyright-form mb-auto">
                <span class="mx-1 powered">Power by</span>
