<div class="apps-botbar fixed-bottom">
    <div class="apps-member light mx-auto">
        <div class="d-flex flex-row justify-content-around">
            <a class="icon-svg home rounded-circle fill <?= @$mn_home ?>" href="">
            ...
            <a class="icon-svg list rounded-circle fill <?= @$mn_list ?>" href="">
            ...
            <a class="icon-svg plus rounded-circle stroke" href="">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 2V8M8 8V14M8 8H14M8 8H2" stroke="" stroke-width="3" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </a>
            <a class="icon-svg wallet rounded-circle fill <?= @$mn_wallet ?>" href="">
            ...
            <a class="icon-svg user rounded-circle stroke <?= @$mn_user ?>" href="">
