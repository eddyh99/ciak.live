            ...
            <a class="icon-svg user rounded-circle stroke <?= @$mn_user ?>" href="<?= base_url() ?>homepage">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="" stroke-opacity="0.5" stroke-width="2.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </a>
        </div>
