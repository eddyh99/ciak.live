...
<input class="form" type="text" id="option_url" style="width:33%" value="rtmp://b.rtmp.youtube.com/live2/qdgv-vf1b-2sxv-55wp-987h?backup=1"/>
<br>
...
<textarea readonly="true" id="output_console"  rows="15" cols="100">
</textarea>
<div id="footer">
