    ...
    <div class="col-11 col-md-7 col-lg-5 mx-auto">
        <div class="apps-body ptop pbot">
            <div class="apps-topbar alerts fixed-top light row">
                <div class="apps-member mx-auto col-12 col-lg-5" style="border-bottom: none;">
                    <div class="alert-notif d-flex justify-content-between px-4 px-lg-0">
                        ...
                        <div class="action">
                            <a href="" class="text-white fs-5">History</a>
                        </div>
                        <div class="action">
            ...
            <div class="apps-member light w-100">
                <div class="row wallet-history">
                    <svg class="mt-2" width="100" height="6" viewBox="0 0 100 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        ...
                        <div>
                            <span>
                                <form id="filterMontly" action="">
                                    <input type="hidden" id="token"
                                            name="<?php echo $this->security->get_csrf_token_name(); ?>"
                                            value="<?php echo $this->security->get_csrf_hash(); ?>">
                                    <input type="month" id="monthlyfilter" class="monthlyfilter" name="monthlyfilter" min="2023-01" value="<?= date('Y-m')?>">
                                </form>
                            </span>
                        </div>
                    </div>
                    <div class="mt-5">
                        <table id="historywallet" class="table table-striped" style="color:white">
                            <thead>
                                <tr>
                                    <th>Description</th>
                                    <th>Amount</th>
