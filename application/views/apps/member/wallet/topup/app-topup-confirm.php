        ...
        <div class="apps-body ptop pbot">
            ...
            <div>
                <div class="apps-member light w-100">
                    ...
                    <h2 class="text-center" style="color: #F83B00;"><?=$_SESSION["currency"]." ".number_format($amount,2)?></h2>
                    <form action="<?= base_url() ?>topup/topup_notif" method="post" class="mt-5">
                       <input type="hidden" id="token"
                        ...
                        <div>
                            ...
                            <div class="topup-receive-input d-flex justify-content-between text-end mt-2">
                                ...
                                <input type="text" id="topup-receive" class="money-input text-end w-100" value="<?=number_format($amountget,2)?>" placeholder="0.00" disabled>
                            </div>
                        </div>
                        <div class="my-5">
                            ...
                            <div class="topup-receive-input-collapse b-border up d-flex justify-content-between text-end mt-2">
                                <label for="you-receive">From</label>
                                <input type="text" id="you-receive" class="money-input text-end w-100" value="<?=number_format($amount,2)?>" placeholder="0.00" disabled>
                            </div>
                            <div class="topup-receive-input-collapse down d-flex justify-content-between text-end">
                                <label for="you-receive">To</label>
                                <input type="text" id="you-receive" class="money-input text-end w-100" value="<?=number_format($amountget,2)?>" placeholder="0.00" disabled>
                            </div>
                        </div>
