        ...
        <div class="posts-member col-12 col-lg-5 mx-auto">
            ...
            ?>
                        ...
                        <div class="post-member <?php echo ($posts->content_type == 'explicit') ? 'explicit-border' : ''?> mt-3 px-4">
                            ...
                            <?php if($posts->is_comment == 'yes'){?>
                                <div id="comment<?= $posts->id?>" class="comment m-3">
                                    <div class="sticky">
                                        <div class="user-input-comment d-flex justify-content-between align-items-center py-2 px-3">
                                            <input type="text" id="inputcomment_<?=$posts->id?>" onkeyup="javascript: if(event.keyCode == 13) postcomment('<?=$posts->id?>', '<?= $_SESSION['username']?>', '<?= $_SESSION['profile']?>');" class="w-100" placeholder="Write a comment">
                                            <span class="f-jakarta btn-comment">
                                                <button type="button" id="publishcomment" onclick="postcomment('<?=$posts->id?>', '<?= $_SESSION['username']?>', '<?= $_SESSION['profile']?>')">Publish</button>
                                            </span>
                                        </div>
                                    </div>
                                    <div id="avail-comment-loading<?= $posts->id?>" class="avail-comment-loading d-none">
                                    ...
                                    <div id="avail-comment<?= $posts->id?>" class="avail-comment">
                                        <div class="prev-comment">
                                            <?php 
                                                if(!empty($posts->comment)){
                                                        ...
                                                        <div class="user-comment d-flex align-items-start">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="ms-2">
                                                                    ...
                                                                    <p class="text-white" style="white-space: pre-line;word-wrap: break-word;"><?= $comment->comment?></p>
                                                                </div>
                                                            </div>
                                                            <!-- <div class="mt-2 px-3">
                                                    ...
                                                    <?php }
                                                    if(count($posts->comment) >= 2){
                                                    ?>
                                                        <div id="read-all-comment<?= $posts->id?>" class="read-all-comment">
                                                            <a onclick="read_all_comment('<?=$posts->id?>')">Read all comments</a>
                                                        </div>
                                                <?php  
                                                        } 
                                                    }
