    ...
    <div class="apps-topbar">
        <div class="apps-member mx-auto">
            <div class="d-flex flex-row">
                <div class="search light me-auto">
                    <input type="text" name="" id="" class="form-control">
                    <span><i class="fa-solid fa-magnifying-glass"></i></span>
                </div>
                <div class="tools-bar ms-3">
                    <a class="rounded-circle light" href=""><i class="fa-regular fa-bell">
                            <span class="buble-red rounded-circle light"></span>
                        </i></a>
                    <a class="rounded-circle light add-border" href=""><i class="fa-regular fa-envelope">
                            <span class="buble-red rounded-circle light"></span>
                        </i></a>
                </div>
            </div>
        ...
        <div class="posts-member">
            ...
            <div class="post-member">
                <div class="post-header mb-3 d-flex flex-row align-items-center">
                    ...
                    <div class="action d-flex flex-row align-items-center">
                        <a href="" class="icon color-bp rounded-circle" data-bs-toggle="offcanvas"
                            data-bs-target="#downloadPicture" aria-controls="offcanvasBottom"><i
