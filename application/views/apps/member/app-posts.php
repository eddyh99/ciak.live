<div class="posts-member">
        ...
        <div class="post-header mb-3 d-flex flex-row align-items-center">
            ...
            <?php if (!isset($mn_search)) { ?>
                <div class="action d-flex flex-row align-items-center">
                    <a href="" class="icon color-bp rounded-circle" data-bs-toggle="offcanvas" data-bs-target="#basketShopping" aria-controls="offcanvasBottom"><i class="fa-solid fa-basket-shopping"></i></a>
                    <a href="" class="icon color-bp dollar rounded-circle" data-bs-toggle="offcanvas" data-bs-target="#sendTip" aria-controls="offcanvasBottom">
                        <div class="bg-white-dollar rounded-circle"></div>
                        <i class="fa-solid fa-euro-sign"></i>
                    </a>
                    <a href="" class="icon ellipsis rounded-circle" data-bs-toggle="offcanvas" data-bs-target="#settingMenus" aria-controls="offcanvasBottom"><i class="fa-solid fa-ellipsis-vertical"></i></a>
                </div>
            <?php } ?>
        </div>
        <div class="post-body">
    ...
    <div class="post-member px-4">
        ...
        <div class="post-footer">
            <div class="like">
                <button class="heart" id="postlike2" onclick="actionLike('1','Like', '2')"><i class="fa-regular fa-heart"></i></button>
                <span>222</span>
            </div>
            <div class="rate-start mx-auto">
                <button onclick="actionStar('1', '2', '1')" name="poststar2" class="star s-1"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '2', '2')" name="poststar2" class="star s-2"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '2', '3')" name="poststar2" class="star s-3"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '2', '4')" name="poststar2" class="star s-4"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '2', '5')" name="poststar2" class="star s-5"><i class="fa-solid fa-star"></i></button>
            </div>
            <div class="action">
                <a href="#" class="icon svg share" data-bs-toggle="offcanvas" data-bs-target="#shareSosmed" aria-controls="offcanvasBottom">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="post-member px-4">
        ...
        <div class="post-footer">
            <div class="like">
                <button class="heart" id="postlike3" onclick="actionLike('1','Like', '3')"><i class="fa-regular fa-heart"></i></button>
                <span>222</span>
            </div>
            <div class="rate-start mx-auto">
                <button onclick="actionStar('1', '3', '1')" name="poststar3" class="star s-1"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '3', '2')" name="poststar3" class="star s-2"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '3', '3')" name="poststar3" class="star s-3"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '3', '4')" name="poststar3" class="star s-4"><i class="fa-solid fa-star"></i></button>
                <button onclick="actionStar('1', '3', '5')" name="poststar3" class="star s-5"><i class="fa-solid fa-star"></i></button>
            </div>
            <div class="action">
                <a href="#" class="icon svg share" data-bs-toggle="offcanvas" data-bs-target="#shareSosmed" aria-controls="offcanvasBottom">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
