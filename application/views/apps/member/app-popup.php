<!-- Start Chart Ciak -->
<div class="offcanvas offcanvas-bottom popup-bottom rounded-top" tabindex="-1" id="basketShopping"
    ...
    <div class="offcanvas-body small text-center pb-5">
        <h5 class="offcanvas-title mx-auto"  id="offcanvasBottomLabel">$2.00</h5>
        <p class="mt-1 mb-3">Are you sure to buy this post?</p>
        <form action="">
            <input type="hidden" value="id">
            <button  class="btn rounded-pill px-4">Confirm</button>
        </form>
    </div>
</div>
<!-- End Chart Ciak -->
...
<!-- Start Send Tip -->
<div class="offcanvas offcanvas-bottom popup-bottom rounded-top" tabindex="-1" id="sendTip"
    aria-labelledby="offcanvasBottomLabel">
    <div class="offcanvas-header">
        <button type="button" class="ms-auto btn-close text-reset" data-bs-dismiss="offcanvas"
            aria-label="Close"></button>
    ...
    <div class="offcanvas-body small text-center pb-5">
        <h5 class="offcanvas-title  mx-auto" id="offcanvasBottomLabel">Send tip?</h5>
        <form action="frmsendtips" class="d-flex flex-column">
            <input type="hidden" name="id_membertips">
            <div class="mt-2 mb-3">
                <div class="rounded-pill bg-input ">
                    <input type="text" name="tipsamount" id="tipsamount" placeholder="$0.00" value="0.5" class="rounded-pill">
                </div>
            </div>
            <div class="">
                <button type="button" id="btnsendtips" class="btn  rounded-pill px-4">Confirm</button>
            </div>
        </form>
    </div>
</div>
