...
let img = $(".icon-ciak-banner");

$('.mode-toggle').click(function(){ 
    
    let modeShow = localStorage.getItem("mode");
    if( modeShow == "dark" ) {
        img.attr("src", "<?= base_url()?>assets/img/new-ciak/icon-ciak-light.png");
    }
    if( modeShow == "light") {
        img.attr("src", "<?= base_url()?>assets/img/new-ciak/icon-ciak.png");
    }
});
