...
<head>
	...
	<link rel="stylesheet" href="https://stream.ciak.live/style.css">
	<link rel="icon" href="https://stream.ciak.live/icon.ico">
	<script>
		var __nspid="isrtzw";
		var __nsptags=[];
...
<li> Enter the RTMP Destination for your api.video stream.  You'll find this at by clicking on your <a href="https://go.api.video/livestreams/">livestream</a>.<br/></li>
<li> When you are ready press "Start Streaming."</li>
</ul>
If you'd like to share your screen & camera, try <a href="https://record.a.video?live=true">record.a.video</a>
</h2>
<hr/>	
...
<br><br>
<input class="form" type="hidden" id="socket.io_address" value="https://stream.ciak.live/"/>
<label class="form" for="option_url" >RTMP Destination:</label>
<input class="form" type="text" id="option_url" style="width:33%" value="rtmp://a.rtmp.youtube.com/live2/qdgv-vf1b-2sxv-55wp-987h"/>
<br>
...
<textarea readonly="true" id="output_console"  rows=15>
</textarea>
<div id="footer">
	This app was created with <a href="https://api.video">api.video</a>.<br/>
	Get the <a href="https://github.com/dougsillars/browserLiveStream">sample code</a>, and read about <a href="https://a.video/works/livestream-a-video">how we built the demo.</a><br/>
