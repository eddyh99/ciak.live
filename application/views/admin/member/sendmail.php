...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <div class="col-12 card sendemail mb-5 mt-3">
                    ...
                    <form action="<?= base_url() ?>m3rc4n73/member/sendmail_proses" method="post" id="form_submit"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="subject" id="subject" class="form-control sendemail-input" placeholder="Type Subject..." required>
                            </div>
                            <div class="form-group row mb-3">
                                <label class="col-12 form-label text-white">Message</label>
                            ...
                            <div class="mb-3">
                                <button id="btnconfirm"
                                    class="btn btn-green-ciak  px-4 py-2 mx-auto shadow-none">Send</button>
                            </div>
                        </div>
                    </form>
                </div>
