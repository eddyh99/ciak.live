...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="col-12 card fee mb-5 mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3" id="topup_circuit_fxd_div">
                        ...
                        <input type="text" id="wallet2wallet_pct" name="wallet2wallet_pct" class="form-control fee-input"
                            readonly>
                    </div>
                    ...
                    <div class="mb-3" id="topup_circuit_pct_div">
                        ...
                        <input type="text" id="referral_lv1" name="referral_lv1" class="form-control fee-input"
                            readonly>
                    </div>
                    <div class="mb-3" id="topup_circuit_pct_div">
                        <label class="form-label text-white">Referral Level 2 (%)</label>
                        <input type="text" id="referral_lv2" name="referral_lv2" class="form-control fee-input"
                            readonly>
                    </div>
