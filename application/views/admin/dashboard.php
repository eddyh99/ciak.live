            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="title d-flex justify-content-end px-4">
                                <span class="fw-bold text-green-freedy me-2">Manajemen</span>
                                <span class="border-end border-1 border-white mx-5"></span>
                                <span class="fw-bold text-green-freedy d-block ms-3 text-end" style="width: 120px;">Balance</span>
                            <?php } ?>
                        </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <?php foreach($ciakbalance as $cb){
                                                            if ($cb["currency"]==$dt){    
                                                    ?>
                                                                <span class="ms-3 d-block text-end" style="width: 120px;">
